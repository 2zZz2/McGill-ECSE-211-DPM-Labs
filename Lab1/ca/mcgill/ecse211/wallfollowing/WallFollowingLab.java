...
public class WallFollowingLab {
  ...
  private static final int bandCenter = 30; // 30 Offset from the wall (cm) 
  private static final int bandWidth = 2; // Width of dead band (cm) //initially3
  private static final int motorLow = 125; // 100 Speed of slower rotating wheel (deg/sec)
  private static final int motorHigh = 200; // 160 Speed of the faster rotating wheel (deg/seec) //initially200
  ...
  public static void main(String[] args) {
    ...
    BangBangController bangbangController =
        new BangBangController(bandCenter, motorLow, motorHigh);
